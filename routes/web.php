...
use App\Http\Controllers\Arsip;
...
Route::get('arsip', [Arsip::class, 'index'])->name('arsip.index');
Route::get('arsip/{slug_arsip}', [Arsip::class, 'show'])->name('arsip.detail');
...
Route::get('prestasi', [PrestasiMahasiswa::class, 'index'])->name('prestasi');
Route::get('prestasi/{slug_prestasi}', [PrestasiMahasiswa::class, 'show'])->name('prestasi.detail');

Route::get('kerjasama', [Kerjasama::class, 'index'])->name('kerjasama');
Route::get('kerjasama/{slug_kerjasama}', [Kerjasama::class, 'show'])->name('kerjasama.detail');
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    // Arsip
    Route::get('admin/arsip', [ArsipController::class, 'index'])->name('arsip');
    Route::get('admin/arsip/create', [ArsipController::class, 'create'])->name('admin.arsip.create');
    Route::post('admin/arsip/store', [ArsipController::class, 'store'])->name('admin.arsip.store');
    Route::delete('admin/arsip/destroy/{id}', [ArsipController::class, 'destroy'])->name('admin.arsip.destroy');
    Route::get('admin/arsip/edit/{id}', [ArsipController::class, 'edit'])->name('admin.arsip.edit');
    Route::patch('admin/arsip/update/{id}', [ArsipController::class, 'update'])->name('admin.arsip.update');
    // Route::resource('/admin/arsip', 'ArsipController');
    ...
    Route::get('admin/prestasi/create', [PrestasiController::class, 'create'])->name('prestasi.create');
    Route::post('admin/prestasi/store', [PrestasiController::class, 'store'])->name('prestasi.store');
    Route::delete('admin/prestasi/destroy/{id}', [PrestasiController::class, 'destroy'])->name('prestasi.destroy');
    Route::get('admin/prestasi/{id}', [PrestasiController::class, 'show'])->name('prestasi.show');
 
 
    // Kerjasama mitra
    // Route::resource('admin/kegiatan', 'KegiatanController');
    Route::get('admin/kerjasama', [KerjasamaController::class, 'index'])->name('kerjasama.index');
    Route::get('admin/kerjasama/create', [KerjasamaController::class, 'create'])->name('kerjasama.create');
    Route::post('admin/kerjasama/store', [KerjasamaController::class, 'store'])->name('kerjasama.store');
    Route::delete('admin/kerjasama/destroy/{id}', [KerjasamaController::class, 'destroy'])->name('kerjasama.destroy');
    Route::get('admin/kerjasama/{id}', [KerjasamaController::class, 'show'])->name('kerjasama.show');
