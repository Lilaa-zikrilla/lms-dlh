            ...
            <div class="row">
                <div class="col-lg-12 col-md-6">
                    <div class="card-title about__text mb-5">
                        <div class="arsip">
                            <h4 class="text-center">{{ $read->judul_arsip }}</h4>
                        ...
                        <div
                            ...
                            <!-- <div class="blog_social">
                                <ul>
                                    <li><a class="whatsapp"
                                            href=" https://wa.me/?text={{ url($read->judul_arsip) }}"
                                            target="_blank"><i class="fab fa-whatsapp" aria-hidden="true"></i>whatsapp</a>
                                    </li>
                                    <li><a class="facebook"
                                            href="https://www.facebook.com/share.php?u={{ url($read->judul_arsip) }}"
                                            target="_blank"><i class="fab fa-facebook" aria-hidden="true"></i>facebook</a>
                                    </li>
                                </ul>
                                <span><i class="fas fa-angle-double-left me-2"></i>Bagikan arsip ini ke yang lainnya
                                </span>
                            </div> -->
                        </div>
                    </div>
