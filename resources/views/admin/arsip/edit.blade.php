                        ...
                        <form action="{{ route('admin.arsip.update', $arsip->id) }}" method="post"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="judul" value="{{ $arsip->judul_arsip }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="keterangan" value=""
                                        ...
                                        placeholder="Keterangan ...">{{ $arsip->isi }}</textarea>
                                    <div class="text-danger">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="user_id" value="{{ old('user_id') }}"
                                        ...
                                        <option value="{{ $arsip->user_id }}"> {{ $arsip->user_id }}</option>
                            ...
                            <div class="card-footer justify-content-between">
                                <a href="{{ route('arsip') }}" class="btn btn-default"><i
