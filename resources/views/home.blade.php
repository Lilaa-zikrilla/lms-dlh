                ...
                @foreach ($alumni as $item)
                    <div class="testimoni-alumni hover-shadow" data-aos="fade-up">
                        ...
                        <div class="card-alumni">
                            <h4 class="title-alumni">{{ $item->nama_alumni }}</h4>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6 col-md-6 mb-3 position-relative">
                        <iframe width="100%" height="310" src="https://www.youtube.com/embed/X152D0k7GWE" 
                        title="YouTube video player" frameborder="0" 
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

                </div>
                <div class="col-lg-6 col-md-6 mb-3 position-relative">
                    <iframe width="100%" height="310" src="https://www.youtube.com/embed/4RW2gXLHFyQ" 
    ...
    <section class="section-sm">
        <div  class="container" data-aos="fade-up">
                ...
                <div class="col-lg-12 col-md-6">
                    <div class="card-pengumuman">
                        <div class="section-heading d-flex align-items-center justify-content-between">
                            <h2 class="text-black">Kerjasama Mitra</h2>
                            <a href="{{ route('kerjasama') }}" class="btn btn-primary-outline">Selengkapnya<i
                                    class="fas fa-angle-double-right mx-2"></i></a>
                        </div>
                        <div class="owl-slide-3 owl-carousel">
                            @foreach ($kerjasama as $item)
                                <div class="course-1-item">
                                    ...
                                    <div class="course-1-content">
                                        <h2> <a
                                                href="{{ route('kerjasama.detail', $item->slug_kerjasama) }}">{{ Str::limit($item->nama_kerjasama, 45, '...') }}</a>
                                        </h2>
                                        <p class="desc">
                                            {!! Str::limit(strip_tags($item->isi), $limit = 50, $end = '...') !!}</p>
                                        <div class="link">
                                            <a href="{{ route('kerjasama.detail', $item->slug_kerjasama) }}"
                                                class="btn btn-primary-outline text-center">Baca
                                                Selanjutnya</a>
                                        </div>
                                    </div>
